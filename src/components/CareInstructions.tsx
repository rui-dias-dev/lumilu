...
const CareInstructions: FC<CareInstructionsProps> = ({ className, ...props }) => {
  return (
    <section className={cn('grid grid-cols-2 gap-6 text-center text-black lg:gap-x-[195px]', className)} {...props}>
      <div className="grid justify-items-center">
        <Flower width={66} height={66} className="lg:h-28 lg:w-28" />
        <p className="mt-5">
      ...
      <div className="grid justify-items-center">
        <Moon width={66} height={66} className="lg:h-28 lg:w-28" />
        <p className="mt-5">
