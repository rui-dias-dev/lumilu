...
const FeaturesAndCare: FC<FeaturesAndCareProps> = ({ className, ...props }) => {
  return (
    <section className={cn('features-and-care', className)} {...props}>
      ...
      <p className="antibacterial px-14 lg:px-0">
      ...
      <br className="lg:hidden" />
      <p className="soft px-14 lg:px-0">
      ...
      <br className="lg:hidden" />
      <p className="natural px-14 lg:px-0">
      ...
      />
      <p className="printing px-14 lg:px-0">
      ...
      <br className="lg:hidden" />
      <p className="non-toxic px-14 lg:px-0">
